...
// Correo>  las validaciones correspondientes(minimo @ y .).
//  No se puede ingresar el mismo correo para dos usuarios diferentes.
// Cargo> Los cargos deben ser Jefe, Analista, Programador, Soporte y Asistente.

// Cuando se cumplan las validaciones y se haga el submit de la informacion,
//  se debe crear una instancia de la clase Empleado, esta clase debe incluir:
...
// En esta seccion se debe ver la informacion registrada por el
//  empleado a manera de un profile del empleado con elementos del tipo
//  input pero que no sean modificables. En la parte inferior del profile
//  deben existir dos botones: "editar" y "guardar".
// Al hacer click en el icono de editar, los inputs deben volverse
//  modificables y permitir que se cambie la informacion seleccionada.
//  Luego se puede guardar la informacion en el mismo objeto haciendo click en el boton "guardar"
...
// sueldoBruto() segun el cargo debe consultar el objeto sueldos y
// retornar el sueldo que corresponde al cargo del empleado.
