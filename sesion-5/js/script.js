// Otra forma de hacer el formulario
const categorias = {
  A: 40,
  B: 35,
  C: 30,
...
function crearSelect(obj, placeholder) {
...
// Crear select a traves de la función crearSelect()
const selectC = crearSelect(categorias, "Categoria");
const selectAnios = crearSelect(
  aniosServicio,
  "Selecciona los años de servicio"
);
